...
public class CalculatorAddrService extends Service {
    ...
    private final static QName CALCULATORADDRSERVICE_QNAME = new QName(
	...
	try {
	    url = new URL(
		    "http://localhost:8080/jax-ws-addressing/CalculatorAddrService?wsdl");
	...
	return super.getPort(new QName(
		"http://addressing.jaxws.webservices.abhijitsarkar.name/",
		"CalculatorAddrPort"), CalculatorAddr.class, features);
    }
