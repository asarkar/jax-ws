 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://abhijitsarkar.name/webservices/jaxws/calculator-cf/", wsdlLocation = "http://localhost:8080/jax-ws-binding/calculator-cf?wsdl")
...
public class CalculatorService extends Service {
	...
	try {
	    url = new URL(
		    "http://localhost:8080/jax-ws-binding/calculator-cf?wsdl");
	...
	return super.getPort(new QName(
		"http://abhijitsarkar.name/webservices/jaxws/calculator-cf/",
		"Calculator"), Calculator.class, features);
    }
