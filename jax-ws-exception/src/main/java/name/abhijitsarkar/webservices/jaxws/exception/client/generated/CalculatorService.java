 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://exception.jaxws.webservices.abhijitsarkar.name/", wsdlLocation = "http://localhost:8080/jax-ws-exception/CalculatorService?wsdl")
public class CalculatorService extends Service {
	...
	try {
	    url = new URL(
		    "http://localhost:8080/jax-ws-exception/CalculatorService?wsdl");
